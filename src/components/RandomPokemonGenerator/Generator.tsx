...
export const Generator: React.FC<GeneratorProps> = ({}) => {
  ...
  // "All Types" Pokemons
  const [pokemonAllTypes, setPokemonAllTypes] = useState<PokemonCardAllTypes[]>(
    allTypePokemonExample
  );
  ...
  const [
    randomPokemonOneType,
    setRandomPokemonOneType,
  ] = useState<PokemonDataInterface>(oneTypePokemonExample);
  // card options
  ...
  const [cards, setCards] = useState<PokeClass[]>([]);
