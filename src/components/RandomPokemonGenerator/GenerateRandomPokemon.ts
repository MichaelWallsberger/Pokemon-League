...
import { PokemonDataInterface } from "../../helpers/Interfaces";
...
const createPokemonForAllType = (pokemonData: PokemonDataInterface, cardType: string) => {
    return (
        {
            "pokemon": pokemonData,
            "type": cardType
...
export const createQualified = (pokeData: PokemonDataInterface, validation: boolean[]) => {
